...
📝 내용 작성 지침:
- "content" 필드에는 "AI 기술이 협상에 미치는 영향과 잠재력에 대해 소개합니다"와 같은 설명이 아닌, 
  실제 강의할 수 있는 구체적인 내용을 작성하세요.
- 예: "AI 협상 에이전트는 머신러닝 알고리즘을 통해 상대방의 협상 패턴을 분석하고, 최적의 협상 전략을 실시간으로 제안합니다. 
  특히 자연어 처리 기술을 활용하여 협상 과정에서 나타나는 감정적 신호를 파악하고, 이를 토대로 협상 전술을 조정할 수 있습니다."
  ...
  "lectures": [
    {{
      ...
      "outline": [
        {{
          "section": "섹션명",
          "content": "강사가 실제로 강의할 수 있는 구체적이고 상세한 내용을 작성하세요. 예: 'AI 협상 에이전트는 다음 세 가지 핵심 기술로 구성됩니다. 첫째, 자연어 처리(NLP) 기술을 통해 협상 상대방의 언어 패턴과 감정 상태를 실시간으로 분석합니다. 둘째, 머신러닝 알고리즘을 활용하여 과거 협상 데이터를 학습하고 최적의 협상 전략을 도출합니다. 셋째, 강화학습을 통해 협상 과정에서 지속적으로 전략을 개선해나갑니다. 실제로 아마존의 Alexa나 구글의 대화형 AI가 이러한 기술을 상업적으로 활용하고 있습니다.'",
        ...
        {{
          "section": "다음 섹션명",
          "content": "강사가 바로 사용할 수 있는 실제 강의 스크립트 수준의 상세한 내용을 작성하세요. 단순한 개요가 아닌 구체적인 설명, 예시, 원리를 포함해야 합니다.",
          "detailed_explanations": [
            {{
              "title": "핵심 개념 설명",
