  ...
  "lectures": [
    {{
      ...
      "outline": [
        {{
          "section": "섹션명",
          "content": "강사가 실제로 강의할 수 있는 구체적인 내용 (150-200자). 예: 'AI 기술은 머신러닝과 딥러닝을 통해 대량의 데이터를 분석하고 패턴을 학습합니다. 특히 자연어 처리(NLP) 기술을 활용하면 텍스트 데이터를 이해하고 분석할 수 있어, 고객 피드백 분석이나 감정 분석 등에 널리 활용되고 있습니다.'",
          "time": "20분"
        }}
      ]
    }},
