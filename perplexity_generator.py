        ...
        try:
            payload = {
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": "당신은 PPT 제작 전문가이자 대학원 수준의 강의 교안 작성 전문가입니다. 실제 기업 사례, 최신 통계 데이터, 구체적 수치를 포함하여 PPT 슬라이드에 바로 사용할 수 있는 실무적인 강의안을 작성합니다. 온라인 검색을 통해 최신 정보를 확인하고, 실제 회사명, 캠페인명, 성과 수치 등을 포함하여 구체적이고 신뢰할 수 있는 내용을 제공합니다."
                    },
                    {
                        "role": "user", 
                        "content": prompt
          ...
          "ppt_slides": [
            {
              ...
              "detailed_content": "상세 설명 (최소 200자, PPT 발표용)",
              "visual_suggestions": "차트/그래프/이미지 제안",
              "speaker_notes": "발표자 노트 (최소 150자)"
            }
          ],
          "real_examples": "실제 기업/산업 사례 (최소 200자)",
          "latest_data": "최신 통계/연구 데이터 (연도와 출처 포함)",
          "practical_tips": ["실무 팁 1", "실무 팁 2", "실무 팁 3"]
        }
      ],
...
검색 활용 지침:
- 최신 업계 보고서, 케이스 스터디, 통계 자료를 적극 검색
- 글로벌 기업들의 성공 사례와 실패 사례 수집
- 최신 도구, 플랫폼, 기술 동향 조사
- 전문가 인터뷰, 업계 설문조사 결과 인용"""
